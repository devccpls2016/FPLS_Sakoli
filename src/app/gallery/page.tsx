...
export default function Gallery() {
  ...
  const videos = [
    ...
    { id: 'P6Z9AY7Hbwc', title: 'Cultural Fest' },
    { id: '2HDU0-aeygI', title: 'Music Concert' },
    { id: 'zT-KZWytLNo', title: 'Debate Competition' },
    { id: 'qEjOZwA3OQo', title: 'Art Exhibition' },
    { id: 'jCvIiLFzqxk', title: 'Annual Sports' },
    { id: 'jrNeZrb_ePQ', title: 'Inter-School Sports' },
    { id: 'ElchCx6NAGw', title: 'Annual Science Fair' },
    { id: 'ElchCx6NAGw', title: 'Science Exhibition' },
    { id: 'ElchCx6NAGw', title: 'Annual Science Fair' },
  ];
